...
describe('Notifications Component', () => {
  ...
  it('renders the first NotificationItem html correctly', () => {
    wrapper.update();
    expect(wrapper.html()).toContain("<div id=\"container\" class=\"container_518m0s\"><div class=\"menuItem menuItem_c0zt1m\">Your notifications</div><div class=\"Notifications notifications_177zlo2\"><img src=\"test-file-stub\" alt=\"close icon\" style=\"height: 15px; position: absolute; top: 10px; right: 10px;\" aria-label=\"Close\"><p>Here is the list of notifications</p><ul class=\"list_g0ajkh\"><li class=\"listItem_cqra0s default_1tsdo2i\" data-notification-type=\"default\">New course available</li><li class=\"listItem_cqra0s urgent_137u7ef\" data-notification-type=\"urgent\">New resume available</li><li class=\"listItem_cqra0s urgent_137u7ef\" data-notification-type=\"urgent\"><strong>Urgent requirement</strong> - complete by EOD</li></ul></div></div>");
  });
});
